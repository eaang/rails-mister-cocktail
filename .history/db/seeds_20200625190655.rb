...
10.times do
  ...
  cocktail = Cocktail.create(name: data['strDrink'].downcase, picture: data['strDrinkThumb'], description: data['strInstructions'])
  ingredients = []
...
def make_cocktail(data)
  ...
  Cocktail.create(name: name, picture: picture, description: description)
end
