...
10.times do
  ...
  cocktail = Cocktail.create(name: info[0], direction: info[2])
  picture = URI.open(info[1])
  cocktail.photo.attach(io: picture, filename: cocktail.name, content_type: 'image/jpg')
  ingredients = []
